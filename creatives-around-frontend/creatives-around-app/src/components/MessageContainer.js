            ...
            <div className="App-Container">
                ...
                <div className="Messages-Container">
                    ...
                    <div className="Message-Container">
                        ...
                        <p><b>Lia:&nbsp;</b> Lorem ipsum dolor sit amet consectetur adipisicing elit.  Sapiente necessitatibus ipsa, sit laudantium ab delectus ea voluptatibus </p>

                    </div>
                    <div className="Message-Container">
                        <img src={Profile1} className="OnlineConnection" alt="" srcset="" />
                        <p><b>Steve:&nbsp; </b>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi nobis minus consequuntur.</p>

                    </div>
                    <div className="Message-Container">
                        <img src={Profile9} className="OnlineConnection" alt="" srcset="" />
                        <p><b>Lia:&nbsp;</b> Lorem ipsum dolor sit amet consectetur adipisicing elit.sit amet consectetur adipisicing. </p>
