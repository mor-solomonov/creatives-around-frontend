            ...
            <div className="App-Container">
                ...
                <div className="ProfileText">
                    ...
                    <p className="ProfileTextInfo">
                        ...
                        Eitan is a self taught Israeli painter who has since 2006 been experimenting with various expressionist technics using mainly Acrylic paint.
                                                Shortly after relocating to Berlin in 2011, he completely switched over to oil paint whilst maintaining the similar artistic visions. Whilst he was suffering a heavy creative block in early 2015 and was unable to create for a couple of months, Eitan made an abrupt change by dedicating himself solemnly to painting small, from life, and in the Alla Prima Technic (one painting in one sitting) on a daily basis. Eitan has since derived influences from classical, but mostly modern artists, who are also sharing a similar passion of expressing through observation.
          </p>
                    <div className="Line" />
                </div>
                ...
                <div className="ProfileText">
                    ...
                    <p className="ProfileTextInfo">
                        I am interested to meet Artist on a similar path and style. I am interested to collaborate in art projects and I am interested to organise a weekly group oil color class at my studio.
          </p>
                    <div className="ArtFormsCollection Container col-md-4 text-center">
                        <button
                            type="button"
                ...
                <div className="ProfileText">
                    ...
                    <a href="https://www.eitanschurart.com/about">
                        <p className="ProfileTextLink"> www.eitanschurart.com</p></a>

                    <h4 className="ProfileTextHeader LinkHeader">Instagram:</h4>
                    <a style={{ textDecoration: 'none' }} href="https://www.instagram.com/eitanschurart">
                        <p className="ProfileTextLink">www.instagram.com/eitanschurart/</p></a>
                </div>
